...
if __name__ == '__main__':
    ...
    #국진
    corners = [50,50,100,100]
    img_src = cv2.rectangle(img_src, (50,50), (100,100), (0,0,255), 10)
    ceil_to_topceil = transform_polygon(matrix, rectangle_to_polygon(corners))
    print(ceil_to_topceil)

    re_ceil_to_topceil = transform_polygon(np.linalg.inv(matrix), ceil_to_topceil)

    pts3 = []
    for pos, old_p in re_ceil_to_topceil.items():
        pts3.append(old_p)
    print(pts3)
    ...
    #
    # #국
    # # pts2 = np.array([[844, 274], [861, 272], [861, 285], [844, 286]], dtype=np.int32)
    # pts1 = []
    # for pos, old_p in ceil_to_topceil.items():
    #     pts1.append(old_p)
    #
    # pts2 = np.array(pts1)
    # cv2.polylines(img_dest, [pts2], False, (0, 0, 255), 10)
