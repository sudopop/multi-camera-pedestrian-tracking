...
if __name__ == '__main__':
    ...
    #matrix 동일하게 변경
    img_src_coordinate = np.float32(img_src_coordinate)
    paste_coordinate = np.float32(paste_coordinate)
    matrix = cv2.getPerspectiveTransform(img_src_coordinate, paste_coordinate)
