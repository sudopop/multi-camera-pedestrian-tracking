...
if __name__ == '__main__':
    # Read source image
    img_ceiling = cv2.imread('./data/sample/7_1.png', cv2.IMREAD_COLOR)
    img_ceiling = cv2.resize(img_ceiling, (960, 540))
    h, w, c = img_ceiling.shape

    img_angle = cv2.imread('./data/sample/7_2.png', cv2.IMREAD_COLOR)
    ...
    cv2.circle(img_ceiling, (779, 535), 3, (255, 255, 0), -1)
    ...
    cv2.circle(img_angle, (950, 266), 3, (0, 0, 0), -1)
    ...
    ceil_pig = [245, 299, 310, 436]  #
    # ceil_pig = [389, 240, 438, 366]  # 나
    ...
    img_result = cv2.rectangle(img_angle, (333, 87), (412, 127), (0, 255, 0), 5) #나
    img_result = cv2.rectangle(img_angle, (657, 43), (691, 79), (0, 255, 0), 5)  # 나
