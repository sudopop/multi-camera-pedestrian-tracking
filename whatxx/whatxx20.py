...
if __name__ == '__main__':
    # Read source image
    img_ceiling = cv2.imread('./data/sample/10_1.png', cv2.IMREAD_COLOR)
    img_ceiling = cv2.resize(img_ceiling, (960, 540))
    h, w, c = img_ceiling.shape

    img_angle = cv2.imread('./data/sample/10_2.png', cv2.IMREAD_COLOR)
    ...
    ceil_pig = [233, 85, 271, 170]  #두환
    ceil_pig = [320, 150, 365, 285]  #나
    ceil_pig = [435, 74, 468, 159]  # 윤경
    ceil_pig = [532, 145, 569, 257]  # 윤경
    ...
    img_result = cv2.rectangle(img_angle, (378, 6), (429, 37), (0, 255, 0), 5) #두환
    img_result = cv2.rectangle(img_angle, (466, 28), (520, 71), (0, 255, 0), 5)  # 나
    img_result = cv2.rectangle(img_angle, (553, -6), (586, 24), (0, 255, 0), 5) #
    img_result = cv2.rectangle(img_angle, (634, 16), (665, 52), (0, 255, 0), 5)  #
