...
if __name__ == '__main__':
    ...
    ac_H = cv2.getPerspectiveTransform(a_top_pts*2, c_top_pts*2) #역함수에 사용할 경우 H (결과는 같음)
    ca_H = cv2.getPerspectiveTransform(c_top_pts*2, a_top_pts*2) #그냥 사용할 경우 H (결과는 같음)
    ...
    ceil_pig = [340, 793, 543, 1068]  #두환
    ceil_pig = [1188, 819, 1252, 1067]  # 두환
