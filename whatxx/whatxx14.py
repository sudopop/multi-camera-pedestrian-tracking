...
if __name__ == '__main__':
    ...
    #ceiling 탑뷰 호모그래피
    c_pts1 = np.float32([[268, 2], [  2., 410.], [551., 0.], [666., 469.]]) #돼지우리 땅바닥 좌표 [[left,top], [left,bottom], [right, top], [right, bottom]]
    ...
    # angle 탑뷰 호모그래피
    a_pts1 = np.float32([[420., 1.], [147., 363.], [686., 0.], [959., 302.]])  #돼지우리 땅바닥 좌표 [[left,top], [left,bottom], [right, top], [right, bottom]]
    ...
    c_top_pts = np.float32([[ 2.,  197.], [ 13., 536.], [958.,  188.], [958., 538.]])  # 돼지우리 땅바닥 좌표 [[left,top], [left,bottom], [right, top], [right, bottom]]
    a_top_pts = np.float32([[84, 90], [ 58., 352.], [958.,  37.], [956., 300.]])  # 돼지우리 땅바닥 좌표 [[left,top], [left,bottom], [right, top], [right, bottom]]턴
    ...
    ceil_pig = [435, 132, 472, 279] #나
    ceil_pig = [113, 283, 193, 429]  # 인턴
    # ceil_pig = [110, 145, 165, 263]  # 인턴
    ...
    img_result = cv2.rectangle(img_angle, (612, 26), (655, 63), (0, 255, 0), 5) #나
    img_result = cv2.rectangle(img_angle, (400, 90), (500, 119), (0, 255, 0), 5) #인
    img_result = cv2.rectangle(img_angle, (352, 48), (439, 80), (0, 255, 0), 5)  # 인
