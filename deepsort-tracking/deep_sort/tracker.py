...
class Tracker:
    ...
    def __init__(self, metric, detector, encoder, max_iou_distance=0.9, max_age=30, n_init=7): #original: max_iou_distance=0.7, max_age=30, n_init=3
        self.metric = metric
    ...
    def predict(self): #can parallalize
