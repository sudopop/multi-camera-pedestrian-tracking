...
if __name__ == '__main__':
    ...
    out = cv2.VideoWriter('multi-tracking_result4.avi', cv2.VideoWriter_fourcc(*'DIVX'), 40, (w, h))
    ...
    while True:
        ...
        stacked_frames = cv2.resize(np.hstack((angled_frame, ceil_frame)), (w, h))
        # cv2.imshow("Multi Camera Tracking", stacked_frames)
        out.write(stacked_frames)
        # out.write(ceil_frame)
