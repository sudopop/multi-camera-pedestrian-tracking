...
sys.path.append("/home/son/Work/pedestrian/multi-camera-pig-tracking/deepsort-tracking/")
sys.path.append("/home/son/Work/pedestrian/multi-camera-pig-tracking/deepsort-tracking/yolov4")
...
class Camera(multiproc.context.Process):
    ...
    def track(self):
        ...
        while True:
            ...
            a_frame, tracks = self.tracker.consume(frame)
